...
| Word sub-checklist: braced parameter operators | busybox/oil var-op suites | Completed: `tests/diff/cases/man-ash-var-ops.sh` + `tests/diff/cases/man-ash-var-ops-matrix.sh` | Covered |
| Word sub-checklist: deep nested quote/substitution combinations | busybox/oil quoting suites | Completed: `tests/diff/cases/man-ash-word-nesting.sh` + `tests/diff/cases/man-ash-word-nesting-matrix.sh` | Covered |
...
5. `man-ash-var-ops-matrix.sh`
6. `man-ash-word-nesting.sh`
7. `man-ash-word-nesting-matrix.sh`
...
| braced parameter operators (`:-`, `:=`, `:+`, `:?`, `#`, `##`, `%`, `%%`, substring) | `word_parser._split_braced_var()`, `expand._split_braced()`, `runtime._expand_braced_param()` | `src/mctash/word_parser.py:294`, `src/mctash/expand.py:501`, `src/mctash/runtime.py:2242` | Covered | `tests/busybox/ash_test/ash-vars/var-pattern-replacement-in-parameter-expansion-*.tests`, `tests/oil/oils-master/spec/var-op-strip.test.sh`, `tests/oil/oils-master/spec/var-op-test.test.sh`, `tests/diff/cases/man-ash-var-ops.sh`, `tests/diff/cases/man-ash-var-ops-matrix.sh` | `tests/busybox/ash_test/ash-vars/var_bash_repl_unterminated.tests`, `tests/busybox/ash_test/ash-vars/param_expand_bash_substring.tests` | Covered for ash/POSIX in-scope operators; bash-only replacement/substring edge forms remain tracked in bash parity boards. |
...
| deep nested quote/substitution combinations | both paths above | `src/mctash/word_parser.py:73`, `src/mctash/word_parser.py:232`, `src/mctash/expand.py:553` | Covered | `tests/busybox/ash_test/ash-quoting/*`, `tests/oil/oils-master/spec/shell-grammar.test.sh`, `tests/diff/cases/man-ash-word-nesting.sh`, `tests/diff/cases/man-ash-word-nesting-matrix.sh` | `tests/busybox/ash_test/ash-parsing/groups_and_keywords2.tests`, `tests/diff/cases/man-ash-word-nesting-matrix.sh` | Covered for ash/POSIX in-scope nesting forms; arbitrary-depth combinatorics remain safeguarded by corpus plus differential matrix. |
