...
| A2-007 | Add fallback-audit regression guard | done | Add regression script/check that fails if new guarded fallback branches are introduced in ASDL expansion path without explicit board item. | New regression case + CI command in docs |
