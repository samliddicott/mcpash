...
5. Prompt escape depth coverage (`PS2`/`PS4` lanes).
   - Requirement row: `C7.INT.01`
   - Evidence: `tests/compat/run_interactive_ux_matrix.sh`
   - Current status: `partial`.
6. Interactive SIGINT continuation parity:
