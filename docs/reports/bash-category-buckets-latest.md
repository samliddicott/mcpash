...
| 3 | Expansion engine | partial | `/home/sam/Projects/pybash/tests/diff/run.sh --case man-ash-var-ops --case man-ash-var-ops-matrix --case man-ash-word-nesting --case man-ash-word-nesting-matrix --case man-ash-glob-matrix --case man-ash-glob-full-matrix --case bash-man-param-transform-ops` | `${v@op}` transformation operators are now tracked as partial with dedicated failing evidence. |
