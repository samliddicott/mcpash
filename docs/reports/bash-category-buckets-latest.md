...
| 6 | Variables/state | partial | `MCTASH_DIAG_STYLE=bash PARITY_MIRROR_POSIX=1 /home/sam/Projects/pybash/tests/diff/run.sh --case man-bash-posix-01-core-state --case man-bash-posix-14-env-exec-flow --case bash-man-timeformat --case bash-man-bash_xtracefd && /home/sam/Projects/pybash/tests/compat/run_interactive_tmout_matrix.sh` | TIMEFORMAT and BASH_XTRACEFD are now covered; TMOUT remains a partial row. |
