...
| 3 | Expansion engine | partial | `/home/sam/Projects/pybash/tests/diff/run.sh --case man-ash-var-ops --case man-ash-var-ops-matrix --case man-ash-word-nesting --case man-ash-word-nesting-matrix --case man-ash-glob-matrix --case man-ash-glob-full-matrix --case bash-man-param-transform-ops --case bash-man-param-transform-ops-variants` | `${v@op}` core scalar/positional/array lanes now execute in bash-compat mode; bucket remains partial for deeper `${v@P}` prompt semantics. |
