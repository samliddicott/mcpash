...
| 6 | Variables/state | partial | `MCTASH_DIAG_STYLE=bash PARITY_MIRROR_POSIX=1 /home/sam/Projects/pybash/tests/diff/run.sh --case man-bash-posix-01-core-state --case man-bash-posix-14-env-exec-flow --case bash-man-timeformat --case bash-man-bash_xtracefd --case bash-man-histtimeformat && /home/sam/Projects/pybash/tests/compat/run_interactive_tmout_matrix.sh` | TIMEFORMAT, BASH_XTRACEFD, and HISTTIMEFORMAT are covered; TMOUT remains the partial row. |
