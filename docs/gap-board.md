...
| Parameter transformation operators `${v@op}` | partial | `tests/diff/cases/bash-man-param-transform-ops.sh` | Detailed operator forms (`@Q,@P,@A,@a,@E,@U,@u,@L`) diverge on mctash (bad substitution path). |
