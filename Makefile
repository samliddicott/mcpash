...
backend-self-parity:
	@./tests/diff/run_backend_self_parity.sh
...
bash-strict-case-map-generate:
	@python3 ./scripts/generate_bash_strict_case_map.py
...
compliance-truth-gate:
	...
	@$(MAKE) bash-matrix-contract-matrix
